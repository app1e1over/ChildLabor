export default class Pagination {
  ...
  render() {
    ...
    if (this.pageCount > 1) {
      ...
      liTag += `<li class="btn prev list-item"><span class="unicode-icon prev-icon">&#8249;</span></li>`;
    }
    ...
    if (this.pageCount > 1) {
      ...
      liTag += `<li class="btn next list-item"><span class="unicode-icon next-icon">&#8250</span></li>`;
    }
    if (this.container) {
